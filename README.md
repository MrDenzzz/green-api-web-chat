...
| Вход                                       | Переписка                               | Мобильная версия                                 |
| ------------------------------------------ | --------------------------------------- | ------------------------------------------------ |
| ![Экран входа](docs/screenshots/login.png) | ![Переписка](docs/screenshots/chat.png) | ![Мобильная версия](docs/screenshots/mobile.png) |
